...
d <- atb %>%
  ...
  ggplot() +
  geom_bar(aes(y = adult_volunteer, fill = first_guardian_marital), position = "fill", width = 0.45) +
  labs(
    x = "Proportion Of Guardians Participating In Adult Volunteering",
    y = "Whether Or Not Guardians Participate \nIn Adult Volunteering",
    fill = "Fist Guardian Marital Status",
    title = "First guardians that are currently married tend to volunteer more",
    subtitle = "First guardians that are divorced tend to volunteer less"
  ) +
  ...
  theme(
    panel.spacing = unit(0.2, "lines")  # Reduce space between the bars
  ) +
...
e<-atb %>%
  ...
  labs(
     x = "Proportion of Guardians Helping Children With Homework",
     y = "How Often Families Help Their Children With Homework",
     title = "Families that eat together 7 days per week tend to help their children with homework more than others"
   ) +
