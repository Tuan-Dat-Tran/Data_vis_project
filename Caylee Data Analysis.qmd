...
atb_noskip %>%
  ...
  labs(x = "Total Household Income", y = "Proportion",
       title = "As income decreases, the proportion of adults who volunteer with the school also decreases") +
  theme_minimal() +
  theme(
...
atb_noskip %>%
  ...
  facet_wrap(~adult_volunteer, labeller = labeller(adult_volunteer = facet_labels)) +
